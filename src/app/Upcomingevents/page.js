        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-cyan-900 relative overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-6 py-20">
                ...
                <div className={`text-center mb-16 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                    ...
                    <h1 className="text-5xl md:text-6xl h-[100px] font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-teal-400 mb-6 animate-gradient-x">
                        Upcoming Events
                    </h1>
                            ...
                            >
                                ...
                                <div className="relative bg-gradient-to-br from-gray-900/50 to-gray-800/50 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-8 h-full overflow-hidden group-hover:border-gray-600/50 transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-purple-500/20">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <div className="inline-flex items-center text-cyan-400 hover:text-cyan-300 font-medium group/btn transition-all duration-300">
                                    ...
                                    {/* Hover Effect Lines */}
                                    <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-cyan-500 via-blue-500 to-teal-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
                                </div>

                                {/* Floating Animation for Hovered Card */}
                                {hoveredCard === event.id && (
                                    <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500 via-blue-500 to-teal-500 rounded-2xl blur opacity-25 animate-pulse"></div>
                                )}
                            </Link>
                        );
                    })}
