  ...
  return (
    <div className="min-h-screen bg-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        ...
        <div
          className={`grid md:grid-cols-2 gap-12 mb-20 transform transition-all duration-1000 delay-300 ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
          }`}
        >
          {/* Mission */}
        ...
        {/* Activities Section */}
        <div
          className={`mb-20 transform transition-all duration-1000 delay-700 ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
          }`}
        >
          <div className="text-center mb-12">
        ...
        {/* Achievements Stats */}
        <div
          className={`mb-20 transform transition-all duration-1000 delay-900 ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
          }`}
        >
          <div className="text-center mb-12">
        ...
        {/* Core Values */}
        <div
          className={`mb-20 transform transition-all duration-1000 delay-1100 ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
          }`}
        >
          <div className="text-center mb-12">
      ...
      <style jsx>{`
        ...
        >>>>>>>upstream/main .animate-gradient-x {
          background-size: 200% 200%;
        ...
        <<<<<<< HEAD ======= .animate-float-slow {
          animation: float-slow ease-in-out infinite;
        }

        >>>>>>>upstream/main .animation-delay-2000 {
          animation-delay: 2s;
        }
