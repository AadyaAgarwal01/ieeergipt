...
export const Navbar = ({
  ...
  return (
    (<motion.div
      ...
      className={cn("fixed inset-x-0 top-10  opacity-90  bg-white-100   backdrop-blur-sm border-2 border-white/20 rounded-3xl shadow-md shadow-[grey]  z-40 w-full", className)}>
